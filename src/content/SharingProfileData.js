...
export default function Content() {
  return (
    <App title={Content.title} defaultTabID="profiler">
      <p>
        Sometimes it can be useful to share profiling data with someone else,
        or to save it for later for comparison purposes.
        Let's familiarize ourselves with the process of exporting profiling data.
      </p>
      <details>
        <summary>
          Show me how.
        ...
        <ol>
          ...
          <li>
            Add or a remove a todo list item.
          </li>
          <li>
      ...
      <p>
        Now let's re-import the data, but first- reload the page or click the <Icon type="clear" /> clear button.
      </p>
      <details>
        <summary>
          Show me how.
        ...
        <ol>
          ...
          <li>
            Select the JSON file that was downloaded earlier.
          </li>
          <li>
